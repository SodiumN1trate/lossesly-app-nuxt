<template>
  <div class="carousel-main-container" v-if="users">
    ...
    <div class="carousel" ref="carousel">
      <div v-for="(user, index) in users" :key="index" class="d-flex align-items-center text-center" style="cursor: pointer; width: 300px">
        <img :src="user.avatar" class="order-user-profile-image" style="border-radius: 50%; width: 70px; height: 70px">
...
export default {
  ...
  updated () {
    this.$refs.carousel.style.width = (this.$refs.carousel.children[0].clientWidth + 70) * 3 + 'px'
  },
  methods: {
    nextPage (direction) {
